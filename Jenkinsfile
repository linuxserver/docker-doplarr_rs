pipeline {
  ...
  environment {
    ...
    EXT_USER = 'activexray'
    EXT_REPO = 'doplarr_rs'
    BUILD_VERSION_ARG = 'DOPLARR_RS_RELEASE'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-doplarr_rs'
    CONTAINER_NAME = 'doplarr_rs'
    DOCKERHUB_IMAGE = 'linuxserver/doplarr_rs'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/doplarr_rs'
    PR_DOCKERHUB_IMAGE = 'lspipepr/doplarr_rs'
    DIST_IMAGE = 'alpine'
    MULTIARCH='true'
    CI='true'
    CI_WEB='false'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-doplarr_rs/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-doplarr_rs\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-doplarr_rs\" \
